...
def output_html(meishiki, unsei):
    ...
    p1 = '&nbsp;' + str(daiun[0][0]) if len(str(daiun[0]
                                                [0])) == 1 else str(daiun[0][0])
    ...
    for i, n in enumerate(nenun):
        if age == n[0]:
            break
    n1 = '&nbsp;' + str(nenun[i][0]) if len(str(nenun[i]
                                                [0])) == 1 else str(nenun[i][0])
    n2 = '&nbsp;' + \
        str(nenun[i+1][0]) if len(str(nenun[i+1][0])
                                  ) == 1 else str(nenun[i+1][0])
    n3 = '&nbsp;' + \
        str(nenun[i+2][0]) if len(str(nenun[i+2][0])
                                  ) == 1 else str(nenun[i+2][0])
    n4 = '&nbsp;' + \
        str(nenun[i+3][0]) if len(str(nenun[i+3][0])
                                  ) == 1 else str(nenun[i+3][0])
    n5 = '&nbsp;' + \
        str(nenun[i+4][0]) if len(str(nenun[i+4][0])
                                  ) == 1 else str(nenun[i+4][0])
    n6 = '&nbsp;' + \
        str(nenun[i+5][0]) if len(str(nenun[i+5][0])
                                  ) == 1 else str(nenun[i+5][0])
    n7 = '&nbsp;' + \
        str(nenun[i+6][0]) if len(str(nenun[i+6][0])
                                  ) == 1 else str(nenun[i+6][0])
    n8 = '&nbsp;' + \
        str(nenun[i+7][0]) if len(str(nenun[i+7][0])
                                  ) == 1 else str(nenun[i+7][0])
    n9 = '&nbsp;' + \
        str(nenun[i+8][0]) if len(str(nenun[i+8][0])
                                  ) == 1 else str(nenun[i+8][0])
    n10 = '&nbsp;' + \
        str(nenun[i+9][0]) if len(str(nenun[i+9][0])
                                  ) == 1 else str(nenun[i+9][0])
    n11 = '&nbsp;' + \
        str(nenun[i+10][0]) if len(str(nenun[i+10][0])
                                   ) == 1 else str(nenun[i+10][0])
